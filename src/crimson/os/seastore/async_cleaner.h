...
public:
   ...
   * promote_extent
   *
   * Promote an extent located in the slow device to the faster device.
   ...
   * Otherwise follow the normal rewrite process but its rewrite generation
   * will be INIT_GENERATION, just like a new extent.
   */
