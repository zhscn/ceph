...
struct LttngBackend
  : ClientRequest::StartEvent::Backend,
    ...
    ClientRequest::PGPipeline::CheckAlreadyComplete::BlockingEvent::Backend,
    ...
    ClientRequest::CompletionEvent::Backend
{
  ...
  void handle(ClientRequest::PGPipeline::CheckAlreadyComplete::BlockingEvent& ev,
              const Operation& op,
              const ClientRequest::PGPipeline::CheckAlreadyComplete& blocker) override {
  }
